// Translate PTT from an input pin to serial data for AnyTone Transceiver 

// Based on info in https://melik.cz/posts/sstv-first-steps/
// Serial Port config is 115200 Baud, 8 bits data frame, 1 stop bit, no flow control
...
int pttPin = 7;                  // PTT line connected to digital pin 7
